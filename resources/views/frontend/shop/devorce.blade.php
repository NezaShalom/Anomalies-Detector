    ...
    <div class="col-lg-12 col-md-12 col-xs-12 space-he">
        <div class="content-wrapper container">
            <div class="breadcrumbs mt-4">
                <a href="/">Ahabanza</a> / Icyemezo cy'ubutane
            </div>
            
            <div class="service-header d-flex pt-4">
                <h4 class="service-preview-title mb-4"> Icyemezo cy'ubutane </h4>
            </div>
          ...
          <div class="">
            @error('minaloc_divorce')<p class="alert alert-danger d-flex align-items-center font-weight-bold" role="alert">
            ...
            <div class="card service-card">
                ...
                <div class="card-body">
                    ...
                    <div class="row">   
                    <form id="divorceform" action="{{ route('divorcestatus.store') }}" method="post">
                        @csrf
                        <input type="hidden" name="service_name" value="Icyemezo cy'ubutane">
                        <div class="col-sm-4">
